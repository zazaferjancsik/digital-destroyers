...
# only want Male/Female for gender specification so split by /
            if type(filtered_dictionaryCHARAC_GEN[letter['title']]['ontology/gender']) == list:
                None
            # None --> doubles (eg: Gerald and Sheila sorted as 1 item taken out)
            else:
                ...
                # filtered_dictionary_CHARAC_GEN_FOR_CSV['fic_character'] = [letter['title']]
                # filtered_dictionary_CHARAC_GEN_FOR_CSV['gender'] = letter['ontology/gender']
